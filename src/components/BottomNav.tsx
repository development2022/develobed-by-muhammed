  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 glass border-t border-white/10 h-20 flex items-center justify-around px-4 lg:hidden">
      <button 
        ...
        className={`flex flex-col items-center gap-1 p-2 ${currentView === 'home' ? 'text-emerald-600' : 'text-gray-500'}`}
      >
        <Home size={24} />
      ...
      <button 
        ...
        className={`flex flex-col items-center gap-1 p-2 ${currentView === 'video_ai' ? 'text-emerald-600' : 'text-gray-500'}`}
      >
        <Video size={24} />
      ...
      <button 
        ...
        className={`flex flex-col items-center gap-1 p-2 ${currentView === 'profile' || currentView === 'login' || currentView === 'register' ? 'text-emerald-600' : 'text-gray-500'}`}
      >
        <User size={24} />
