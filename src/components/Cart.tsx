...
import { ShoppingCart, ChevronLeft, ChevronRight, Minus, Plus, MapPin } from 'lucide-react';
            ...
            {cart.length > 0 && (
              <div className="p-4 border-t border-white/10 bg-[#1a1a1a] space-y-3">
                ...
                <div className="pt-2 space-y-3">
                  <label className="block text-xs text-gray-500 uppercase tracking-widest font-bold">
                    {t('selectedAddress')}
                  </label>
                  
                  <div className="w-full border-2 border-dashed border-white/10 rounded-2xl p-6 bg-white/5 relative">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-[#262626] border border-white/10 rounded-xl px-4 py-3 text-sm outline-none focus:border-emerald-600 transition-colors h-20 resize-none"
                  />
                </div>
