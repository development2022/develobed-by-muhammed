      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-red-600 rounded-2xl overflow-hidden flex items-center justify-center">
          ...
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center text-gray-400 hover:bg-red-600 hover:text-white transition-all">
              <Instagram size={20} />
            </a>
            <a href="#" className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center text-gray-400 hover:bg-red-600 hover:text-white transition-all">
              <Facebook size={20} />
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400 text-sm">
            <li><a href="#" className="hover:text-red-600 transition-colors">{t('home')}</a></li>
            <li><a href="#" className="hover:text-red-600 transition-colors">{t('allProducts')}</a></li>
            <li><a href="#" className="hover:text-red-600 transition-colors">{t('specialOffers')}</a></li>
            <li><a href="#" className="hover:text-red-600 transition-colors">{t('about')}</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400 text-sm">
            <li><a href="#" className="hover:text-red-600 transition-colors">چەرەزات</a></li>
            <li><a href="#" className="hover:text-red-600 transition-colors">شیرینی</a></li>
            <li><a href="#" className="hover:text-red-600 transition-colors">قاوە</a></li>
            <li><a href="#" className="hover:text-red-600 transition-colors">دیاری</a></li>
          </ul>
        </div>
