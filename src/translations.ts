...
export const translations = {
  ku: {
    ...
    geolocationNotSupported: "گەڕان بەدوای شوێن لەلایەن وێبگەڕەکەتەوە پاڵپشتی ناکرێت",
    unableToRetrieveLocation: "نەتوانرا شوێنەکەت دیاری بکرێت. تکایە بە دەستی هەڵیبژێرە.",
    deliveryAddress: "ناونیشانی گەیاندن",
    provideAddress: "تکایە ناونیشانی گەیاندن بنووسە",
    profileUpdated: "زانیارییەکان بە سەرکەوتوویی نوێکرانەوە",
    profileUpdateError: "هەڵە لە نوێکردنەوەی زانیارییەکان",
    thankYouPurchase: "سوپاس بۆ کڕینت!",
    orderRegistered: "داواکارییەکەت بە سەرکەوتوویی تۆمارکرا",
    apiKeyMissing: "کۆدی Gemini ئامادە نەکراوە. تکایە ڕێکخستنەکان بپشکنە.",
    promoPlaceholder: "بۆ نموونە: SHERDLL10",
  ...
  ar: {
    ...
    unableToRetrieveLocation: "تعذر الحصول على موقعك. يرجى الاختيار يدوياً.",
    deliveryAddress: "عنوان التوصيل",
    provideAddress: "يرجى تقديم عنوان التوصيل",
    profileUpdated: "تم تحديث الملف الشخصي بنجاح",
    profileUpdateError: "خطأ في تحديث الملف الشخصي",
    thankYouPurchase: "شكراً لشرائك!",
    orderRegistered: "تم تسجيل طلبك بنجاح",
    apiKeyMissing: "مفتاح Gemini API غير مهيأ. يرجى التحقق من الإعدادات.",
    promoPlaceholder: "مثال: SHERDLL10",
  ...
  en: {
    ...
    unableToRetrieveLocation: "Unable to retrieve your location. Please select manually.",
    deliveryAddress: "Delivery Address",
    provideAddress: "Please provide a delivery address",
    profileUpdated: "Profile updated successfully",
    profileUpdateError: "Error updating profile",
    thankYouPurchase: "Thank you for your purchase!",
    orderRegistered: "Your order has been successfully registered",
    apiKeyMissing: "Gemini API key is not configured. Please check your settings.",
    promoPlaceholder: "e.g. SHERDLL10",
  ...
  tr: {
    ...
    tapOnMap: "Haritaya dokunun veya GPS kullanın",
    useMyLocation: "Konumumu Kullan",
    selectedAddress: "Seçilen Adres",
    gettingAddress: "Adres alınıyor...",
    pleaseSelectPoint: "Lütfen haritada bir nokta seçین",
    confirmLocation: "Konumu Onayla",
    selectYourLocation: "Konumunuzu seçین",
    tapToOpenMap: "Haritayı açmak için dokunun",
    geolocationNotSupported: "Coğrafi konum tarayıcınız tarafından desteklenmiyor",
    unableToRetrieveLocation: "Konumunuz alınamadı. Lütfen manuel olarak seçین.",
    deliveryAddress: "Teslimat Adresi",
    provideAddress: "Lütfen bir teslimat adresi girin",
    profileUpdated: "Profil başarıyla güncellendi",
    profileUpdateError: "Profil güncellenirken hata oluştu",
    thankYouPurchase: "Satın aldığınız için teşekkürler!",
    orderRegistered: "Siparişiniz başarıyla kaydedildi",
    apiKeyMissing: "Gemini API anahtarı yapılandırılmadı. Lütfen ayarlarınızı kontrol edin.",
    promoPlaceholder: "örn. SHERDLL10",
    yourLocationOnMap: "Haritadaki konumunuz",
