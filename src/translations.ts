...
export const translations = {
  ku: {
    ...
    categoryImage: "وێنەی هاوپۆل",
    chooseCategoryImage: "وێنەیەک هەڵبژێرە بۆ هاوپۆلەکە",
  ...
  ar: {
    ...
    chooseCategoryImage: "اختر صورة للفئة",
  ...
  en: {
    ...
    chooseCategoryImage: "Select an image for the category",
  ...
  tr: {
    ...
    chooseCategoryImage: "Kategori için bir resim seçin",
